...
Create folders and files on your host machine:
These will be volume mounted to kafka-connect service.
...
This appendix explains how to build your own Kafka Connect SMT (like the RegexMask transform you implemented).
This is essential for learners who want to extend Kafka Connect with custom transformations.
...
1. A Java class implementing:

org.apache.kafka.connect.transforms.Transformation<R>

2. A JAR file containing your compiled classes
...
Kafka Connect will not discover your SMT without this file.
...
C. How to Verify That Kafka Connect Loaded Your SMT
...
If you see Class not found, discovery failed.
...
If working, validation shows no errors.

If failing:

Class com.rrp.connect.RegexMask$Value could not be found
